...
from Practica441 import Practica441  # grc-generated hier_block
...
class Practica41(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica41")
        ...
        self.Practica441_0 = Practica441(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Practica441_0, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.Practica441_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Practica441_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Practica441_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Practica441_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.Practica441_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Practica441_0.set_Ac(self.Ac)




def main(top_block_cls=Practica41, options=None):
